...
## Round 1: The Objection

*What did [Name] find when they first read the paper? Make the failure concrete and specific. A vague "concerns about scalability" is not a block. The actual blocking issue had a name and a mechanism.*
...
*[Same: specific failure, not vague concern.]*

**Verdict: BLOCKED**

*[One or two sentences: what the BLOCK decision said, and the minimum required to clear it.]*
