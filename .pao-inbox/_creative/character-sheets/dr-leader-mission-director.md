...
- **Languages:** Arabic native, English fluent (working language of international polar science), French competent (if Sorbonne or NYU AD doctoral path).
...
To complete the mission cleanly. To deploy the instrumentation. To return the crew alive. To get the climate data home and into the hands of the scientists who will use it. The architecture is supposed to make all of this routine.

## What she needs (different from what she wants)

To accept that she has built an architecture that will not outlast her. To name her own fear and write it into the staff history without disguising it. To stop carrying the locked-iPhone pattern as private dread and put it on the page where the next architect can read it.
...
- Does NOT deliver speeches about local-first principles. She is a working oceanographer-commander, not a manifesto deliverer. The architecture's value is shown through her actions, not her slogans.
...
> *I have built a system that is failing at the moment it matters most. I have built the next family's locked iPhone. I have built the call I cannot answer.*
...
When the CO calls the UAE friend (per outreach plan in `.pao-inbox/_decisions/antarctic-vision-chapter-concept-2026-04-30.md`), this character sheet is the artifact to share. The friend's reactions to:
- Name authenticity
- Career arc plausibility (NYU AD → Woods Hole → Khalifa University)
- Family configuration ("would a senior Emirati professional woman this age typically have...")
- Religious practice level
- Voice samples (do they read as Emirati or as Western projection?)
- Anything that signals "they got it" vs "they wrote a generic Gulf character"

...will lock the remaining open decisions and let the chapter draft begin.
