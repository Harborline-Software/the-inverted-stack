...
visibility: drafter-only
status: canonical (locked 2026-05-05; CO directive)
do_not_reference_from_vol2_prose: true
related:
...
> **What this is for:** chapter drafters and the technical-book-writer agent should know the destination so that Vol 2's planting is structurally sound. Joel's discipline registers as quietly substrate-laying because the drafter knows what it becomes. Wanjiru's institutional thinking registers as institution-building because the drafter knows what survives. The reader does not see the destination. The drafter does.
...
| Forensic substrate | Post-mission analysis of pre-failure timestream | Post-incident analysis on any ship | Same property; centuries of legal and institutional development |
| Preservation guarantee | Conditional on Bridge sync; long-now durable on consortium ports | Federation-archive distributed across centuries | Same conditional-preservation reality; institutional framework matured |
| Replication | Boat-internal across crew nodes; Bridge replication via surface windows | Ship-to-ship; ship-to-Federation-archive; ship-to-system; ship-to-civilization | Same CRDT-replication primitives; scale changed |
| Failure-mode (OSS-funding asymmetry) | Sensor-head supply-chain compromise | Vendor-capture in any era | Recurring; institutional defenses harden; capital adapts |

## 7. What this means for Vol 2 chapter drafting

The chapter-drafter, knowing the destination, writes:

- **Joel's discipline** as quiet, civilizationally weighty by what it *becomes*, never by what he *says*. He is a US Navy nuclear engineer who built a sync protocol. That is all he is. The reader will sense the rest in time.
- **Wanjiru's institutional thinking** as already past-the-boat. Her chapter beats include moments where she is reading the regulatory landscape, drafting the eventual standards-body work, registering the supply-chain pattern. She does not say *I will found the institution*. She does the work that becomes the institution.
- **Anna's recording** as competent first-time authorship. She is curating from the archive. Her diary is hers. Her staff history is hers. She is not writing for centuries; she is writing because Wanjiru asked. The reader who knows the destination registers the weight.
- **Stefan's adversarial position** as architecturally specific. He is not generically corrupt. He is the engineer who failed to disclose, then chose centralization, then chose vendor-capture as a strategy. His position recurs across the centuries because *capital concentrates*; he is its first specific instance.
- **The architecture's properties** as load-bearing. Preservation. Capture. Forensic substrate. Graceful degradation. These are what survive. The chapter-drafter exercises each in operational reality without preaching.

## 8. The forbidden registers

What chapter drafters must NOT write into Vol 2 prose:

- *The system would later learn to do without me asking.* (forecast register; out)
- *Decades from now, this will become...* (out)
- *I had no idea what this would become.* (prophecy register; out)
- *The architecture was the seed of...* (out)
- *Centuries from now...* (out)
- *In time, the standards body would become...* (out)
- Any phrase that places Anna, Joel, or Wanjiru as foreseeing the trajectory.

The trajectory exists. The Vol 2 prose does not reach toward it. The reader feels it retroactively. The drafter writes toward it without naming it.
...
- **Locked 2026-05-05** per CO directive. Series-canon-only document.
- **Hard rule:** never referenced from Vol 2 prose; only from drafter briefs and contributor onboarding.
- **Future books** will reference this document as the canonical destination they continue toward.
