...
| Crew role | Origin | Demographic notes |
|---|---|---|
| **CO / Mission Director** | New (UAE) | Emirati oceanographer; name TBD pending CO outreach to UAE friend |
| **Mission Medical Officer** | **Maria Santos** (Ch1 hospital data-loss disaster) | Latina; designed the mission's offline-first medical-records system; full arc from Ch1 victim to mission authority |
| **Lead Instrumentation Engineer** | **Construction PM** (Ch1) renamed | South Asian or GCC; designed the modular ice-shelf monitoring instruments; Ch1 failure mode became her credential for sealed-environment work |
| **Logistics & Procurement Officer** | **BFSI loan officer** (Ch1) renamed | South Asian; manages multinational consortium funding under jurisdictional pressure; rural-BFSI offline-first credential transfers |
...
CO's directive: no autobiographical/personal details in the Antarctic chapter or the book. Implications:
...
## The CO's fear (the chapter's emotional through-line)
...
6. **Earn the dedication through scene, not announcement.** Reader has to feel by the last page why this matters; the chapter cannot tell them.
...
CO will reach out to UAE professional associates for cultural input on the Emirati CO character. The friends do not yet know about the book. Outreach should be low-pressure, time-boxed, with opt-out free of social cost.
...
**On naming (most pitfall-prone):**
1. Would these names read as off, presumptuous, or wrong-region? [Khalid Al Mansoori, Hessa Al Maktoum, Mohammed Al Marzooqi, Reem Al Hashemi, Saif Al Mazrouei]
2. Is there a tribe/family-name combination to avoid for a fictional commoner?

**On the professional Emirati profile:**
3. What does the typical career arc look like for a senior Emirati scientist in international science? Education, study-abroad path, milestones at age 40-50?
4. Family or social expectations that would shape how a CO in their forties or fifties is positioned?

**On texture details:**
5. If I write an Emirati protagonist on a multinational research vessel for several months, what details signal authenticity to an Emirati reader? Prayer rhythm, language switching, dietary considerations, anything that says "they got it" rather than "they wrote a generic Gulf character"?
6. Are there small habits or sayings (Arabic phrases that slip into English naturally, ways of greeting/closing conversations, family references) that would land as authentic without being heavy-handed?

**On what would land wrong:**
7. Tropes about Emirati or Gulf characters in Western fiction that are tiring, condescending, or inaccurate?
8. Is there anything about how Emirati professionals are portrayed in Western media that you wish writers would do differently?

**On the emotional thread:**
9. The CO has an emotional throughline involving distance from family during a long deployment. Are there cultural considerations about how a senior professional Emirati son thinks about family during extended absence? I don't want to project a Western emotional template.

**On their involvement going forward:**
10. Would you be willing to read a 600–800 word concept note, and the chapter draft when it's done, for accuracy? Optional both steps.

### Things NOT to ask

- Don't ask them to "explain Emirati culture" (too broad).
- Don't ask them to teach Arabic phrases on demand (have them react to drafted phrases instead).
- Don't make it feel like an oral exam.
- Don't apologize repeatedly for not knowing.
- Don't ask about politics, ruling families, religious sensitivities in current events, or anything touching where they have to be professionally careful.

### Cultural pitfalls flagged for CO before the call

- **Ruling family names** (Al Nahyan in Abu Dhabi, Al Maktoum in Dubai, Al Qasimi in Sharjah/RAK, Al Sharqi in Fujairah, Al Mualla in Umm Al Quwain, Al Nuaimi in Ajman) are seven emirates' royal families. Using them for a fictional commoner reads as presumptuous or politically loaded. Stick to professional-class family names like Al Mansoori, Al Marzooqi, Al Mazrouei, Al Hashemi, Al Shamsi.
- **"Captain" title for an oceanographer**: in international scientific maritime work, "Captain" usually refers to the vessel's master. The CO of a research mission is often "Chief Scientist" or "Mission Director" with a separate Captain (vessel master) under them. Friend can advise on which title.
- **Female Emirati professionals in senior science roles** is real and increasingly visible (Sarah Al Amiri ran the Mars Mission). Friend may have specific input on what reads as authentic.
- **Bilingual reality**: UAE professionals at this level switch English/Arabic constantly, often mid-sentence. Friend can describe what that actually sounds like.
...
5. **Polar destination** (Filchner-Ronne ice shelf vs Ross Sea vs other). Filchner-Ronne preferred for climate-collapse stakes; Ross Sea more iconic. CO call.
6. **Chapter placement**: replaces existing Epilogue, OR becomes new chapter "The Crossing" before existing Epilogue. PAO needs to read current Epilogue before recommending.
7. **Chapter length target**: 4,000–6,000 words estimated. Memoir register supports meditative pace.

## Concept note status

NOT YET DRAFTED. Concept note is the next deliverable once CO has UAE friend input + locks decisions 1-5 above. Estimated length: 600–800 words. Will be reviewed by CO + (optionally) UAE friend before chapter draft begins.
...
If CO returns with UAE friend input and asks to resume:
1. Read this document in full.
2. Update the "Open decisions" section with what CO locked.
3. Draft the 600–800-word concept note as next deliverable.
4. Do NOT start writing the chapter until concept note is approved.
5. Ch12 polish remains paused until CO signals to resume the lit-board sweep.

If CO returns and wants to redirect entirely (different setting, different protagonist, etc.):
1. Read this document in full so the reasoning behind each design choice is preserved.
2. Mark this document as superseded.
3. Begin a new concept-state doc reflecting the new direction.

If CO returns and asks to skip the concept note and go straight to drafting:
1. Push back gently. The concept note is the cheapest possible alignment artifact before 4,000–6,000 words of chapter draft. Skipping it means rewriting the chapter.
2. If CO insists, draft the chapter but keep the King critique items (antagonist material; Maria still scarred; CO's specific fear named; architecture appears to fail before succeeds; death scened in present tense; dedication earned not announced) load-bearing in the draft.

---

**End of concept-state document.** Captures the full creative direction from 2026-04-30 conversation. Resume cleanly from here.
