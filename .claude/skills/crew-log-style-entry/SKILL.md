...
7. **No anti-AI-tells** — consult `.claude/skills/anti-ai-tells/SKILL.md` if uncertain. (No `delve`, `tapestry`, `underscore`, no significance-puffery, no signposting.)
...
- **Anti-AI-tells:** `.claude/skills/anti-ai-tells/SKILL.md` — consult before finalizing.
- **Literary devices:** `.claude/skills/literary-devices/SKILL.md` — restraint is the default; devices land harder when the surrounding prose is plain.
