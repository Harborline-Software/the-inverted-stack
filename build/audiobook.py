...
CHAPTER_FILES = [
    ...
    # 2026-05-13: Ch 01 + Ch 02 trial drafts (Filchner / Bobiverse register)
    #             promoted to canonical paths after voice-compliance
    #             cleanup pass and listen-test approval.
