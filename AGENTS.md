...
Four subagents are defined in `.Codex/agents/` (also installed at user scope `~/.Codex/agents/`).
...
Canonical protocol spec: `SunfishSoftware/coordination/README.md` and Sunfish `AGENTS.md` § "Live signaling to XO".
