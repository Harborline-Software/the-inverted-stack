...
Maria came up at eighteen-forty-seven during the routine afternoon watch. She said Priya had been in the engineering compartment with Joel for four hours and had not surfaced for the wardroom tea at sixteen hundred and had not surfaced for the pre-dinner ration at seventeen-thirty either. Maria did not frame the report as a medical concern. She framed it the way Maria framed things when she was not making it a medical concern but was noting, at the medical-officer's bearing, that someone on the boat had been on a problem long enough that the body's intake schedule had become information.

I said *acknowledged*.

The bridge held its routine. The bathymetry was running the half-degree south against the consortium model the way it had run since Day 39; Diego was at the polar-operations console; the second-watch officer was reading the indications. The hand-off was at nineteen hundred. Eleven minutes remained. The half-watch signed at eighteen-fifty-eight. Then I went down to the engineering compartment.

The compartment was at the lower-deck configuration I had seen Priya working in across Segment 1 and Segment 2 - the calibration hardware racked along the inboard bulkhead, the deployment-rated sensor heads in the steel cradles forward, the workstations along the outboard bulkhead. The lab section ran into the engineering compartment at the bulkhead aft. Priya had set up at the lab-engineering bulkhead. She was at the workstation directly against the bulkhead. Joel was beside her at a second workstation set perpendicular to hers, a metre to her right. A third workstation was up at the bulkhead opposite - the larger screen that ran the local LLM's indexing output, set to read distance for both of them. The screen was up at the schema-evolution corpus's annotated view. The annotation showed the old-schema-to-new-schema field mapping in the two-column layout the corpus rendered at, with the local-LLM's annotations against each field-map row in the third column.
...
Joel had a printed standing-procedure on his workstation and the small engineering laptop beside it. The laptop was open at his standing-watch log. He was reading too. He was at the rate Joel read when he was reading something he was about to operate against. He did not look up when I came into the compartment (which meant he was inside the procedure rather than in the compartment, and would not surface until the procedure was read; the crew had stopped finding this rude six years ago).

Priya did. She turned her head when I came in. Her shoulders were set. Her jaw was tight. The set was the set I had seen in the lab at Day 5, in the four-pass-signature scene, and again at the segment-boundary anomaly on the morning of Day 39. The set was the set the body held when the discipline was being held.
...
The wardroom desk was a two-minute walk. The filing was in the audit log against the engineer's-notes header at the timestamp Priya had named. Read it twice. A third time. The filing's structure was the structure I had read in three of Priya's prior filings on the boat - the refusal of record, the conditions, the safety net, the rollback path - but the load was different. The conditions were tighter. The safety net was tighter. The rollback path was specified at a level of granularity I had not seen Priya specify before. The fourth pass was new.

The filing closed. Back to the engineering compartment.
...
The shape of this I had heard once before - in a session I had read about in the council-review record but not seen in person. The R1 near-hold on the schema-migration mechanism. Three weeks of work, alone in her home office, building the test cases that exercised the third-party-read pattern. The fix had been a constraint added to the spec. The constraint added partition-time. The constraint had been the right constraint; the constraint was now in the audit-log's evolution corpus on the screen across the compartment from us; the constraint was what the boat was now operating under.

She had been selected for this. The schema-migration mechanism was hers; the careful-conservative-precision was hers; the body-of-work that had arrived at the contraction-phase rewrite was hers. Neither of us had anticipated that the architecture would put her in the case her rewrite did not contemplate.
...
Command log, personal-reflection entry: *I am the precondition for the safety net. If I do not respect the no, the yes-with-conditions does not exist; the safety net does not exist; the architecture's response to this case becomes a thing the boat does not have access to. The discipline that holds the migration is procedural. The procedure depends on the command authority respecting the procedure's refusals. I am that authority. The respect is the operational requirement, not the personal courtesy.*

The entry closed. Not filed. Marked personal-reflection, encrypted under my key, access self-only. It would not enter the main record. It might enter later, if and when I chose to surface it, in the curation that would happen after the mission.

The bridge at twenty-twelve. Second-watch handoff stood at twenty-fourteen. Rack at twenty-two-forty-one. Sleep did not come until the early hours.

---

The council-review record on Priya's R1 near-hold had been read before the recruitment. Read again at the Bengaluru meeting three months before departure. Carried in the way one carries senior context on a senior crew member - in the way the reading shapes the recruitment without surfacing in the recruitment conversation.

The reading. Priya had filed her R2 fix at her home office in Bengaluru, late evening, after three weeks of work. The R1 council had surfaced a near-hold on her schema-migration mechanism: under contraction-phase with an unhealed partition, two nodes that had each migrated independently could converge with non-identical canonical schemas, undetected until a third-party read tried to reconcile them. The original assumption had been that two-party schema-version handshake was sufficient. The discovery had been that two parties could each handshake successfully with the same third party at different times, and the third party would then see inconsistent canonical schemas without an indication of the divergence.
...
The reviewer who had signed the R2 conditions was the council's principal reviewer for the schema-migration mechanism. The reviewer was not Joel. The reviewer was the council member whose review had surfaced the original near-hold.
...
The recognition was noted. Not filed. Held. Sleep came.

---

The bridge at oh-five-fifty, Day 44.

The boat's master was at the bridge. He had been advised at the second-watch handoff and again at the morning watch. He confirmed the minimum-operational-tempo window: oh-six-hundred to oh-seven-thirty as the outer envelope, oh-six-hundred to oh-six-forty-five as the expected interior. The boat would hold trim against the standard operational depth on bearing two-three-seven. The acoustic floor would be allowed to lay down at the routine tempo; the bathymetry refresh at the polar-operations console would drop to the standard rate; Diego had agreed at the morning brief at oh-five-thirty. The compute hub had suspended RAG indexing at oh-five-fifty against the indexer's standing-suspension procedure. Wanjiru's relay was dormant; the comm watch was at minimum tempo; the second-watch officer in the comm space had been advised. Maria was at the medical bay at routine watch.

The boat was the boat at minimum tempo. The conditions were the conditions Priya had set.

Down to the engineering compartment at oh-five-fifty-five.
...
He typed. The pass log on Priya's workstation logged the entry. The pass log read *PASS 1 - INITIATED - 0600:14*.
...
The pass log recorded *FIELD MAP APPLY - INITIATED - 0600:42*.
...
The pass log recorded *PASS 2 - HOLD - 0613:42*.
...
The pass log logged the tighter-window read.
...
The compartment was quiet. The hum was the hum. The local-LLM bulkhead screen showed the pass-three initiation at oh-thirty-one-fifty-eight. The screen's annotation column waited for the read-back results.

Joel watched his timer. Priya watched her workstation. Neither spoke. The boat's master clock advanced.

At ninety seconds, the cycle ran the read-back. The pass log logged each field's read-back. The deviation plot's pass-three read-back column populated.
...
The pass log recorded *PASS 3 - HOLD - 0033:42*.
...
He invoked the partial rollback. The rollback procedure ran. The pass log logged the rollback at oh-thirty-six-forty-two. He reconfigured field eighteen with explicit-not-default semantics. He re-ran pass three on field eighteen.
...
The door of the compartment had held me since oh-thirty-five. Down from the bridge at oh-thirty after the boat's master had reported the trim was holding clean against the routine tempo and the bathymetry refresh was at the standard rate and the boat was at the operational tempo Priya had specified. The door, because nothing at the workstations was mine to contribute. The door, because the migration's end needed a witness. The door, because command authority's standing was the standing the work was operating under. Priya had marked me at oh-thirty-six during the field-eighteen rollback. No nod. Nothing said. She had seen me. The acknowledgment was the acknowledgment.

What I was watching was not what the spec was watching. The spec was watching for read-skew faults at the four-minute window. I was watching an engineer who had been the only woman in three of the four labs she had worked in before this boat, and the only South Asian engineer in two of those, finish the work of catching a semantic loss that every reviewer above her grade in the consortium would have signed off on at the application layer without surfacing the storage layer at all. The discipline was not the spec's. The spec had been edited to require what Priya already did. The edit had been Priya's filing two years ago. What was running in the compartment now was an architecture that had been taught by the engineer who was operating it - and the teaching had happened at a council where she had filed a fix the council had not asked her for, and had filed it correctly because the correctness was what she had against the room. I did not file this thought. I held it at the door.
...
At four minutes, the cycle ran the read-back. The pass log logged each field's read-back. The deviation plot's pass-four read-back column populated.
...
The pass log logged the lock release at oh-fifty-two-twenty-six.

Priya said: *the boat returns to operational tempo at the routine pace. The minimum-tempo window closes at oh-fifty-three.*
...
The bridge. Boat's master advised at oh-fifty-three. The minimum-tempo window closed. The boat resumed routine. The bathymetry refresh returned to the high rate at oh-fifty-six. Diego was at his console; he had stood the window at the lower refresh; he returned to his standing tempo without comment. Wanjiru's relay returned to comm-watch routine. The compute hub resumed RAG indexing at oh-fifty-eight. Maria stood the medical bay at routine. The boat was the boat.

---

Back down to the engineering compartment at oh-eight-fifteen.

Priya was at her workstation, filing. Joel was at his workstation, also filing. The local LLM's bulkhead screen had returned to index-only profile. The compartment was at the post-operational tone - the quiet a compartment carried in the half-hour after a procedure had cleared, when the operators were running the closing entries and the muscle memory of the procedure was still in the body.

The filing work was not mine to interrupt. The close was worth marking in person.
...
I stood in the compartment for another forty-six seconds. Joel was filing his standing-watch entry at the pass-by-pass log. He read the entry at the rate he filed engineering-watch entries at. He paused at the field-eighteen entry. He looked over at Priya.
...
*Migration committed. Canonical schema version four-point-one-point-zero. Cross-instrument-cross-check between starboard and port probes scheduled at the noon brief. Standing engineering watch resumed at the routine tempo at oh-fifty-three.*

*- P. Iyer, Lead Instrumentation Engineer. Filed; hash 9e3a...82f1.*

---

The post-migration filing read at ten-oh-three. Twice. The filing closed the thread.

The wardroom corner. The boat had returned to operational tempo across the back two hours; the routine had reasserted; Diego had filed the half-degree south on the cross-section read at the noon brief. Priya's cross-instrument-cross-check between starboard and port had cleared at twelve-fourteen against tolerance; the migration's purpose had been served; the starboard probe's firmware-failure-mode field was now surfacing the diagnostic state the firmware had been generating since Day 39; the back twenty-four hours had logged four anomalous-state events, two below the watchword threshold and two at the watchword threshold; none had reached the firmware's escalation threshold; the probe was operating within the firmware's specified behaviour. The cross-check had confirmed the redundancy. The boat's auxiliary-salinity reading was now adequately monitored against the firmware-state the original schema had been suppressing.

Both filings read at the desk - Priya's pre-migration filing from the night before, and Priya's post-migration filing from the morning. Read in the register reserved for filings that have closed a thread worth carrying.
...
The differential was noted. Held.
...
The no had not been overridden. The no had become the yes-with-conditions. The yes-with-conditions had become the migration. The migration had cleared. The architecture had held because the architecture had Priya. The architecture had Priya because the selection had targeted the temperament the council reviewer had recommended at the close of the R2 session. The selection had been the operational requirement. The respect of the no had been the operational requirement. The architecture's response to the case had been the operational requirement. The chain ran the way the chain ran.
...
The filing closed. Command log, personal-reflection entry: *the architecture worked because Priya's caution was built into it as a constraint, not because the mission followed her caution as a rule*. Encrypted under my key, access self-only, like the prior night's entry. It would surface later, or not.

Not now. The bridge for the afternoon watch.
