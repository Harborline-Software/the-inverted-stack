...
I was on the bridge for it. The boat's master ran the dive sequence at the tempo the dive sequence ran at, and the deck plates under my boots took on the angle a vessel takes on when the vessel ceases to be a surface vessel and becomes a different kind of vessel, and the band of grey-green water that had been off the port quarter at the start of the cycle was no longer water by the seventh minute. The pumps cycled. The trim seated. The boat steadied. The instrument panel registered three hundred meters at oh-five-forty-six. The relay layer transitioned from active to dormant at the same moment the trim seated; Wanjiru reported the transition clean from the comm space; the gossip protocol on the consortium-port side registered the dormancy at the level grey it had registered on the morning of Day 7 and again at the close of the surface window two days earlier.

I did not log the dive entry the way I had logged it on the morning of Day 7. The morning of Day 7 had been the morning the partition register first became operational. The morning of Day 23 was the morning the partition register became routine. The boat's master called the depth without staging. The deck officer acknowledged without staging. I signed the dive entry. The entry chained into the local store the way the entry on Day 7 had chained, and the way the entry on Day 21 had chained at the surface transition. The dive was the dive. The boat was at depth. Segment 2 had commenced.

I went below.

The wardroom hum was the wardroom hum. The light was the wardroom light. The hatch into the conference space was open at the angle it had been open at on the morning of Day 7. The body had not, this morning, registered the colour of the water above the hull at the way the body had registered it at three hundred meters on the morning of Day 7. The colour above had been the same colour. The body had not paused to register it. The chapter-of-Segment-2 had begun the way Joel had said it would, which was the way the architecture had said it would, which was at the routine tempo with the partition register now installed in everyone on the boat as the operational floor.
...
She said: *I would like an hour with you and Joel.*
...
Joel came in at oh-eight-fifty-seven. He had the tablet, the printed copy of the council review he had carried on the recruitment call, the notebook, and the coffee he drinks when the coffee is for the work. He sat at the bench opposite me. He did not ask what the meeting was for. He had registered, from Sabina's request and the timing and the register Sabina had used, that the meeting was Sabina's meeting and that he was here in the supporting register. He had set himself in the supporting register before he sat down.
...
Joel registered the constraint. He did not interrupt.

She said: *the consortium's contingency for the case is a delegated counter-signature, signed at capture by the procurement officer of record, attested under the consortium's established custody chain, transmitted to the consortium's portal during the next available relay window after capture. The funding office will accept the propagation gap if the attestation timestamps fall inside the window and the custody chain is intact. The mechanism is in the procurement framework as an explicit allowance. It has been used before, by other missions, in similar configurations. It has not been used by us.*

She said: *I do not want to exercise it for the first time in production at oh-nine on Day 28 with the consortium's window already running and the tranche depending on the counter-signature landing inside the window. I would like to exercise it now, on a dry run, with Joel walking the architecture's behaviour and me walking the procurement framework, and the validation logged so that on Day 28 the procedure is the procedure we have already run.*

She finished. She set the sheet down at the centre of the bench.

I said: *acknowledged.*

She said: *I have the consortium's allowance text in the folder. Geneva signed off in writing on the delegated-counter-signature pattern for our specific case in the third week of August. AARI's legal office acknowledged it. The procurement framework permits it. The legal authority permits it. What I do not yet have is the architectural confirmation that the boat-side capture, attestation, and propagation will produce the artifact the consortium portal will accept, with the timestamp metadata in the form the funding office requires, with the custody chain not broken by the partition.*

She looked at Joel.

She said: *walk me through what the architecture will do when I sign on Day 28 and what it will produce at Surface 2 on Day 37. I would like to know it now.*

Joel said: *acknowledged.*

He said it the way Joel said *acknowledged* when a senior officer had brought him a real question and he had registered the question at the altitude the question lived at. He took a breath.

He said: *the case is in the specification. I will walk it. Stop me when I have not been precise.*

Sabina nodded. She picked up the pencil.

---

Joel said: *the counter-signature lands on your local store first. It signs at capture against your key. The capture timestamp is the timestamp the funding office is asking for. The architecture treats it as the truth of when the signature was made; it is independent of the propagation timestamp.*

He said: *the signature chains into the consortium's prior chain — Geneva, AARI, the Punta Arenas port authority — all of which are already in your local store from the surface window two days ago. The chain composes the way it composed at the surface transition for the in-port acknowledgments.*

Sabina wrote on the sheet in the angled hand she wrote in.

He said: *between Day 28 and Day 37 the gossip protocol broadcasts the signature to the boat's mesh; every node carries it within the cycle window. The consortium-port side is dormant; the propagation queue holds the signature against the dormant state. The hold is not a fault; it is the operational state the architecture names for the case.*

Sabina said: *the hold preserves the capture timestamp.*

He said: *the hold preserves the capture timestamp. At Surface 2 the relay transitions to active and the queue dequeues. The artifact carries both timestamps — capture from Day 28; propagation from Day 37. The funding office reads the capture against the window. Your capture is inside. The propagation is outside, but the consortium's allowance text — the one in your folder — names the propagation gap as acceptable.*

Sabina said: *the custody chain.*

He said: *intact across the transition. Your signature chains into the prior chain at capture; the prior chain is in your local store. The boat's nodes counter-attest on the local mesh at gossip-cycle tempo. At Surface 2 the consortium's portal counter-signs at the consortium layer; the audit log composes the layers in arrival order. No layer is lost. The chain is not broken; the chain is paused. The pause is documented. The documentation is the partition's signature on the record.*
...
Joel said: *I should walk what the architecture does not do.*

Sabina nodded. She had been waiting for the second part.

He said: *between Day 28 and Day 37 the consortium's portal will not register the existence of your signature. If the funding office queries the portal in that window, the query returns that the counter-signature has not arrived. The architecture has not lied; the architecture has not yet propagated. The two are different. But a query during the gap will read as not-yet-signed.*

Sabina said: *the allowance text covers that case. The funding office is on notice that propagation can lag the window. The response *not yet propagated* is the response the framework designs for. I have the Geneva pre-clearance citing the response-text. I am inside the propagation-gap allowance, not the signature-not-made fault category.*

Joel said: *one more.*

He said: *if the boat does not surface at Day 37 — if Surface 2 is delayed by weather or by the boat's operational state — the held signature waits at the protocol layer for the relay to come back. The hold accumulates duration. Whether the longer gap remains acceptable is the framework's tolerance, not the architecture's. You will know it as a procurement risk, not as an architectural one.*
...
Sabina said: *acknowledged.*

She wrote.

She said: *the dry run.*

---

He said: *I will produce a counter-signature on a synthetic record at a synthetic capture timestamp. We will run the gossip cycle. We will hold the artifact in the queue. We will simulate a relay-active transition. We will dequeue. We will inspect the artifact against the portal's envelope. If the comparison is clean, the procedure is the procedure for Day 28.*

Sabina said: *Joel.*

She said his name the way Sabina says a senior officer's name when she is about to add a constraint the senior officer has not yet named.

She said: *the synthetic record uses the actual consortium chain from the surface window two days ago. Not the live counter-signature window — the chain from the in-port acknowledgments. The chain is real. If we run the dry run on a synthetic chain we are testing the boat against itself. We are not testing the portal against the boat's artifact. The synthesis is the timestamp. The chain is real.*
...
I said: *run the dry run today. Bring me the artifact and the portal-envelope confirmation before the brief tomorrow. The procedure on Day 28 is the procedure that comes out of today. If anything in the dry run does not behave the way Joel said it would behave, I want to know it before the brief.*

Sabina said: *understood, Director.*

Joel said: *understood, Director.*
...
He said it in the register he uses when an officer he respects has come to his shoulder for the kind of check-in that is not a check-in. He had registered me coming up. He had registered that I had not asked him a question. He had given me the sentence the morning required, which was the sentence that told me his work was running on the metric his work ran on. He gave it once. He gave it cleanly. He returned to his screens.

I said: *acknowledged.*

I stood at his shoulder for another second. The console hummed. The angle of his eyes did not change. The discipline of his attention was the discipline of his attention. I had known his discipline from the Drake — *the calmest man on the manifest had set the calmest watch I had registered* — and I knew it now in Segment 2 in the same texture. The texture had not changed. He was the watch's quiet centre. He did not need me at his shoulder. He had registered that I had needed to register him there.

I went forward.

---

Diego came up the ladder from the polar-operations station as I came forward through the wardroom. He had a printout of the under-ice routing for the next five days in his hand and a pencilled deviation in the upper margin. He saw me. He said: *Director.*
...
He said it the way Diego said operational information — flat, factual, in the senior-operator-to-senior-operator register he had with everyone on the boat. He had been pulled by Sabina into her dry-run preparation in the half hour before the dive, and he had walked her through the polar-operations dimension of the case at the altitude she had asked for, and he had done it without making her ask twice.
...
Wanjiru was at her station. She had the surface-window-1 reconciliation still resident on her secondary screen — the prioritization log, the queue's arrival order, the consortium's counter-signatures filed from the morning of Day 21. The primary screen carried the standing partition status panel, with the relay layer dormant in the level grey and the duration field reading 0d 03h 14m. The hum was on. She nodded.

She said: *Director.*

I said: *the relay layer.*

She said: *dormant. The transition was clean. Joel cleared the synthetic-flag with me at oh-nine-twenty-eight; I have the queue-priority log open for Sabina's dry run. The audit log will tag the artifact with the flag; the dry-run will not contaminate the live record. Both layers — protocol and procurement — recognize it.*
...
She said it without my asking. She said it in the register she gave reports in when the report was a report I would want before I asked. Priya's check during the dive had been the same check she had filed on the morning of Day 7 in the conference space. The discipline was the discipline. The schema was stable.
...
The boat's master had the watch. The deck officer was at the dive station. The instrument panel registered three hundred meters of depth. The trim held. The carrier-acoustic floor under the boat was the floor it had been at oh-five-forty-six and would be at oh-five-forty-six on Day 24 and on Day 25 and on the days the segment carried me through to Day 37. I gave the master the nod I had given on the morning of Day 7. He acknowledged.
