...
Joel took the constraint in. He did not interrupt.
...
He said: *between Day 28 and Day 37 the consortium's portal will not show your signature as received. If the funding office queries the portal in that window, the query returns that the counter-signature has not arrived. The architecture has not lied; the architecture has not yet propagated. The two are different. But a query during the gap will read as not-yet-signed.*
