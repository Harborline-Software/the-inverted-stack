...
let kLabel   = "com.inverted-stack.reader"
let kPlist   = "\(NSHomeDirectory())/Library/LaunchAgents/\(kLabel).plist"
let kLogFile = "\(NSHomeDirectory())/Library/Logs/inverted-stack-reader.log"
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func buildMenu() {
        let menu = NSMenu()
        add(menu, "The Inverted Stack Reader", tag: -1, enabled: false)
